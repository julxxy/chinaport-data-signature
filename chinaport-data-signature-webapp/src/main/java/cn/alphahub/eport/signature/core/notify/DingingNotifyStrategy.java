 ...
 */
@Slf4j
@Component(DingingNotifyStrategy.NAME)
public class DingingNotifyStrategy implements NotifyStrategy<Object> {
    public final static String NAME = "dingingNotifyStrategy";
